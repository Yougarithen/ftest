...
class Produit {
    ...
    static async create(data) {
      ...
      INSERT INTO Produit (code_produit, nom, description, unite, poids, unite_poids, stock_actuel, prix_vente_suggere, taux_tva, soumis_taxe, qte_palette)
  ...
  `, [id]);
    ...
    static async update(id, data) {
      ...
      SET code_produit = $1, nom = $2, description = $3, unite = $4, poids = $5, 
          unite_poids = $6, prix_vente_suggere = $7, taux_tva = $8, soumis_taxe = $9, qte_palette = $10
      WHERE id_produit = $11
      RETURNING *
    `, [
            data.code_produit,
